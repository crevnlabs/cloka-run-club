            ...
            return (
                <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-zinc-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <h2 className="mb-4 text-xl font-semibold text-center text-zinc-800">Something went wrong</h2>
                        <p className="mb-4 text-zinc-600 text-center">We apologize for the inconvenience. Please try refreshing the page or contact support if the problem persists.</p>
